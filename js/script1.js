...
if (window.matchMedia("(min-width:767px").matches) {
  const toggleNavbarMethod = document.getElementsByClassName("dropdown-toggle");
  for (const toggle of toggleNavbarMethod) {
    toggle.removeAttribute("data-bs-toggle", "dropdown");
  }
}
//remove link on dropdown in mobile
